...
class PersonTicketInfo extends StatefulWidget {
  final String nom;
  final Color color;
  PersonTicketInfo({required this.nom, this.color = Colors.black});
  @override
    ...
    return Column(
      children: [
        Container(
          ...
          child: Center(
              child: Image.asset(widget.color == Colors.black
                  ? "assets/utilisateursexeneutre-white.png"
                  : "assets/utilisateursexeneutre.png")),
        ),
        SizedBox(
          height: 10,
        ),
